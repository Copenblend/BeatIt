namespace BeatIt.Assets;

/// <summary>
/// Provides constant glyph strings for Microsoft Codicon font icons.
/// Each constant maps a codicon name to its Unicode character for use in UI bindings and XAML.
/// </summary>
